...
class V2RiskOptimizedTradingJob:
    ...
    async def initialize_system_components(self) -> bool:
        ...
        try:
            ...
            # 5. Enhanced ViperAsyncTrader (Main Trading Engine)
    ...
    def calculate_v2_position_size(self, price: float, balance: float, leverage: int = 50) -> float:
        """Calculate position size with STRICT 2% risk and max leverage optimization"""
        try:
            # STRICT 2% RISK CALCULATION
        ...
        try:
            ...
            for opportunity in opportunities:
                try:
                    ...
                    position_size = self.calculate_v2_position_size(price, balance, self.max_leverage)
