...
Write-Host "⚠️  IMPORTANT: Your real API credentials will be encrypted." -ForegroundColor Red
...
⚠️  REMEMBER: Your real API credentials are encrypted in this backup.
